...
wandb.init(
    ...
    project='re5000',
    name='incremental-resolution-final-run-50-epoch-cyclic'
)
...
model = FNO(n_modes=(128, 128), hidden_channels=width, n_layers=1, in_channels=1, out_channels=1, incremental_n_modes=(2, 2))
