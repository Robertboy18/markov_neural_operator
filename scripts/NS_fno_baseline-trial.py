...
wandb.init(
    ...
    project='re5000',
    name='resolution-32modes-128-incremental-resolution-hardcap32'
)
...
model = FNO(n_modes=(128, 128), hidden_channels=width, n_layers=4, in_channels=1, out_channels=1, incremental_n_modes=(32, 32))
